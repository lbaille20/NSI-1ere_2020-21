...
##graphique_donnees_base(XYE_donnees_base(DonneesEtiquetees))    
...
plt.title("Données de base de E. Anderson", fontsize=24)
plt.scatter(X0,Y0,color='red',label="iris setosa")
plt.scatter(X1,Y1,color='blue',label="iris virginica")
plt.scatter(X2,Y2,color='green',label="iris versicolor")
...
plt.savefig("fig0 - Données de E. Anderson.png")
plt.show()
